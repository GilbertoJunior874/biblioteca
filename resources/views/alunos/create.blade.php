            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800">
                    ...
                    <form action="{{ route('alunos.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="registration" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Matrícula:</label>
                            <input type="text" name="registration" id="registration" class="form-input mt-1 block w-full" required>
                        </div>
